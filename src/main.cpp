...
int main(void) {
    ...
    bit_vector prev_leaf = int_list_to_bits({183, 231, 178, 111, 197, 66, 169, 241, 210, 48, 239, 205, 118, 75, 152, 233, 23, 244, 68, 121, 155, 134, 181, 131, 32, 157, 253, 177, 49, 186, 62, 132}, 8);
    ...
    bit_vector leaf = int_list_to_bits({78, 144, 206, 42, 80, 100, 176, 75, 200, 232, 113, 98, 19, 218, 162, 124, 58, 186, 16, 209, 143, 237, 155, 247, 76, 51, 189, 234, 207, 145, 110, 196}, 8);
